...
export const messages = {
  INVALID_WEB_INPUT:'Enter a search of 1–400 characters, a location up to 100 characters and valid search options (70 words total maximum).',
  WEB_REQUEST_USED:'This search request was already handled. Start a new search to try again.',
  WEB_DAILY_LIMIT:'The shared limit of 100 web search pages per 24 hours has been reached. Please try later.',
  PROVIDER_RATE_LIMITED:'Brave Search has reached its request or subscription limit. Please try later or check the Brave plan.',
  UNAUTHORIZED:'Operator access is required.', OPERATOR_NOT_CONFIGURED:'Operator access has not been configured on the server.',
  CAMPAIGN_UNAVAILABLE:'This campaign is paused, exhausted or already running.', DAILY_LIMIT:'The daily research limit has been reached.',
  SCHEDULER_NOT_CONFIGURED:'Scheduled research is not configured.',
